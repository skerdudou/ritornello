...
import CdAdmin, { contract } from './index'
...
describe('module contract', () => {
  ...
  it('requires `base`, with no default value', () => {
    ...
    // "/plugins/cd/" would be wrong — silently — as soon as an operator
    // declares it under another name, and all its requests would go to a
    // nonexistent plugin.
    const props = (CdAdmin as unknown as { props: Record<string, { required?: boolean; default?: unknown }> }).props
