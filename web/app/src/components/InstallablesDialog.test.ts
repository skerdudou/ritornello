...
const CATALOG = {
  ...
  installables_no_catalogue:
    'This release publishes no description of its components; only their names are known.',
...
function mountDialog(components: ComponentOffer[]) {
  return mount(InstallablesDialog, { props: { open: true, components }, attachTo: document.body })
}
