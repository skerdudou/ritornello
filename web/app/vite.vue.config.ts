...
export default defineConfig({
  // Le mode `build.lib` ne substitue step `process.env.NODE_ENV` (il suppose
  ...
  // au niveau module — le browser n'a step de `process` global, l'evaluation
  ...
  build: {
    ...
    outDir: 'dist/assets',
    // Le build de l'app est passe avant : ne step vider, sinon on efface
